...
final class DTCUtilsTest extends TestCase {
    ...
    /**
     * Unit test for getNumberOfWeekdays() function
     */
    ...
    /*
     ...
     $dateSep1 = DateTime::createFromFormat(DTCUtilsTest::$DATE_FORMAT, date(DTCUtilsTest::$DATE_FORMAT,  mktime(00,00,00,8,1,2018)));
     $dateSep7 = DateTime::createFromFormat(DTCUtilsTest::$DATE_FORMAT, date(DTCUtilsTest::$DATE_FORMAT, mktime(00,00,00,8,3,2018)));
     $numberofWeekDays = 0;
    ...
    // Check the invalid parameter
    // This is quit irrelevant as  ???????
